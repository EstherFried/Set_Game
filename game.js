...
//     console.log()
//     if (recordsJson == null) {
//        record = { username: username, date: new Date(), succ: successes };
//       localStorage.setItem("records", JSON.stringify(record));
//     }
//     else {
//       let recordsList = JSON.parse(recordsJson);
//       if (recordsList.length < 5) {
//         let record = { username: username, date: new Date().getDay() +"-"+ new Date().getMonth() +"-"+ new Date().getFullYear, guessCount: guessCount };
//         recordsList.push(record);
//         localStorage.setItem("records", JSON.stringify(recordsList));
//       } else {
//         let maxGuessCount = 0;
//           let record = { user: username, 
//             date: new Date(), succ: successes };
//           recordsList.push(record);
//           recordsList.sort(function (a, b) {
//             return a.succ - b.succ;
//           })
//           recordsList.splice(5);
//           localStorage.setItem("records", JSON.stringify(recordsList));
//         }
//     }
